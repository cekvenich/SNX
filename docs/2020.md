...
Analytics section requires cooler heads to architect due to hype (related to AI, ML, DS, etc.). Ideally someone who has helped implemented a **statistical** or a predictive system in the past should be responsible for this area.

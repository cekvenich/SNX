...
Summary: There are 2 radical differences in today's Java ecosystem relative to the prior decade. The listed difference amount to a difference in kind, not a difference in degree. 
...
There is a helper class that wraps this method in an executor to simulate appropriate load. 

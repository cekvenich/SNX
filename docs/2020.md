...
# DRAFT: Java ecosystem's 10 Best Practice pillars for the 2020s decade
...
Note, if you find typos or issues in this draft, please contact me, I have limited time to do open source.

### Bio

I am Vic Cekvenich, my claim to fame is writing the first book on Java Struts, a predecessor to Spring. I have been looking at Apache Spark, Akka, Spring boot, etc. and I think we can improve. There are even a few ideas we can leverage from NodeJS's Express library and JAMstack.org
...
But here is what we use in NodeJS, something more nodern:

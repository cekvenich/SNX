...
- And if there is a Blockchain Hyperledger use case, consider implmenting it as PGP. 
...
- Analytics section may also include a rules engine, such as Drools

- Analytics section may also include 'bots' (eg. Puppeteer ). They are used for scraping external data (eg. SEO rankings), and more.

Performance monitoring of your UX, or some version of APM, is usually in the analytics section architecture. <br />
...
I did not show a fat Docker container as it is classic code.

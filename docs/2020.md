...
In Chess, there is a library of named openings, such as Queens Gambit. The opening, first 10 scripted moves or so, is played very quickly, and after it is on the board, the middle game starts where the moves are always different. There is a chess opening that is frequently played by international grand masters, informally called 'Gand Prix', (a line that 

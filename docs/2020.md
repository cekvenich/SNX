...
Again, there are 3 main parts, this time they are: the cloud **data storage** section of the arcitecture - on top left, **analytics** section of the arcitecture - on the botton, and the **app** section of the arcitecture - on the right.
...
is faster development iteration, since there is no schema. You can just write JSON lists to S3. 
...
VPN(Bastion) DMZ NAT VPC. Baseline? IPTables
